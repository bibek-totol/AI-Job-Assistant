    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: "radial-gradient(ellipse at right, rgba(0,229,190,0.05) 0%, transparent 65%)",
        }}
      />
      ...
      <div className="relative max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div ref={headerRef} className="mb-20">
          <div className="flex items-center gap-3 mb-6 header-el" style={{ opacity: 0 }}>
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            ...
            <p
              ...
              style={{ color: "rgba(255,255,255,0.28)", fontFamily: "'DM Sans', sans-serif", opacity: 0 }}
            >
            ...
            return (
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  gsap.to(iconWrap, { borderColor: "rgba(255,255,255,0.18)", background: "rgba(255,255,255,0.07)", duration: 0.3 })
                }}
                onMouseLeave={(e) => {
                  gsap.to(e.currentTarget, {
                    background: "#0c0c0c",
                  ...
                  const numEl = e.currentTarget.querySelector(".feat-num")
                  gsap.to(numEl, { color: "rgba(255,255,255,0.08)", duration: 0.25 })
                  const iconWrap = e.currentTarget.querySelector(".icon-wrap")
                  gsap.to(iconWrap, { borderColor: "rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.04)", duration: 0.3 })
                }}
              >
                {/* Number label */}
                <div
                ...
                >
                  <Icon style={{ width: "18px", height: "18px", color: "rgba(255,255,255,0.45)" }} />
                </div>
