...
export default function ATSScoreCard({
  ...
  return (
    <div className="space-y-6">
      {/* Score Display */}
      <div className="bg-slate-700 border-6  border-cyan-400 shadow-[0_0_100px_rgba(6,182,212,0.5)] backdrop-blur-sm rounded-2xl shadow-lg p-8 text-center">
      ...
      {/* Strengths */}
        <div className="bg-slate-700 border-6  border-cyan-400 shadow-[0_0_100px_rgba(6,182,212,0.5)] backdrop-blur-sm rounded-2xl shadow-lg p-6">
